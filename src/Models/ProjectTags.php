...
class ProjectTags
{
     ...
     */
    private static int $tag_limit = 0;
     ...
     */
    private static string $tag_email_header_name = '';

    /**
     * @var string
     * How the tag values are serialised, if adding tags directly to email header
     */
    private static string $tag_email_header_serialisation = 'multi';

    /**
     * @var string
     * How the tag values are delimited, if using serialisation
     */
    private static string $tag_email_header_value_delimiter = ',';
}
